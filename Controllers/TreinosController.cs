...
namespace WebTreinosAcademia.Controllers
{
    public class TreinosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,nometreino,descricaotreino,duracao,dificuldade,professorResp")] Treino treino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,nometreino,descricaotreino,duracao,dificuldade,professorResp")] Treino treino)
        {
            if (id != treino.id)
            {
                return NotFound();
